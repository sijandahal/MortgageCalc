        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <h1 className="text-2xl text-[#124E66] text-bold"><span className="font-bold">Sijan </span>Home Loan</h1>
            </a>
          </div>
          ...
          <div className="flex flex-1 justify-end">
            ...
            <motion.a href = "/LoginPage" class="group relative inline-flex h-[calc(48px+8px)] items-center justify-center rounded-full bg-[#124E66] py-1 pl-6 pr-14 font-medium text-neutral-50">

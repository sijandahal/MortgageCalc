      ...
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            {/* <motion.a
              href="/Mortgage"
              class="group relative inline-flex h-12 items-center cursor-pointer justify-center overflow-hidden rounded-md bg-[#124E66] px-8 font-medium text-neutral-200"
